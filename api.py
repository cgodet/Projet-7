...
def json_application_test():
  application_test_dict=application_test.to_dict("records")
  return jsonify(application_test_dict)
...
def json_application_test_preprocessing():
  ...
  application_test_preprocessing_dict=application_test_preprocessing.to_dict("records")
  return jsonify(application_test_preprocessing_dict)
